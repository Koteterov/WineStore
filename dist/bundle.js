...
`;async function h(t){t.render(d(c.o)),(0,r.MN)(),(0,r.l$)()}i()}catch(u){i(u)}}))},644:(t,e,s)=>{s.a(t,(async(t,i)=>{try{s.d(e,{z:()=>p});var a=s(885),r=s(40),n=s(555),o=s(160),c=s(718),l=s(18),d=s(135),h=t([o,c,l,d]);[o,c,l,d]=h.then?(await h)():h;const u=(t,e)=>a.dy`
  <!-- navbar -->
  ${(0,o.y)()}
...
`;async function p(t){try{const e=await(0,r.lP)(t.params.id);t.render(u(l.o,e)),(0,n.MN)(),(0,n.l$)()}catch(t){console.log(t)}}i()}catch(f){i(f)}}))},713:(t,e,s)=>{s.a(t,(async(t,i)=>{try{s.d(e,{u:()=>u});var a=s(885),r=s(555),n=s(18),o=s(718),c=s(40),l=s(135),d=t([n,o,l]);[n,o,l]=d.then?(await d)():d;const h=(t,e,s,i,r)=>a.dy`
  <!-- navbar -->
  <nav class="navbar">
...
`;async function u(t){const e=(await(0,c.gp)()).filter(((t,e)=>{if(1==e||5==e||9==e)return t}));t.render(h(n.o,r.lg,r.l6,e,(function(){t.page.redirect("/products"),(0,l.RT)()}))),(0,r.MN)(),(0,r.l$)()}i()}catch(p){i(p)}}))},452:(t,e,s)=>{s.a(t,(async(t,i)=>{try{s.d(e,{K:()=>u});var a=s(885),r=s(40),n=s(555),o=s(160),c=s(718),l=s(18),d=t([o,c,l]);[o,c,l]=d.then?(await d)():d;const h=(t,e)=>a.dy`
...
`;async function u(t){const e=l.o;t.render(h(e,(async function(e){e.preventDefault();const s=new FormData(e.target),i=s.get("email").trim(),a=s.get("password").trim();if(!i||!a)return(0,n.h4)("Please fill in both fields!");try{await(0,r.x4)(i,a),t.page.redirect("/products")}catch(t){clg(t.message)}}))),(0,n.MN)(),(0,n.l$)()}i()}catch(p){i(p)}}))},112:(t,e,s)=>{s.d(e,{M:()=>a});var i=s(885);function a(t){t.render(i.dy`<h2>404 Not Found</h2>`)}},880:(t,e,s)=>{s.a(t,(async(t,i)=>{try{s.d(e,{a:()=>u});var a=s(885),r=s(555),n=s(160),o=s(718),c=s(18),l=s(40),d=t([n,o,c]);[n,o,c]=d.then?(await d)():d;const h=(t,e,s)=>a.dy`
    <!-- navbar -->
...
`;async function u(t){const e=c.o,s=JSON.stringify(e),i=e.map((t=>t.qty)).reduce(((t,e)=>t+e),0);t.render(h(e,(async function(e){e.preventDefault();try{await(0,l.Kf)({order:s}),localStorage.removeItem("tempOrder"),c.o.length=0,t.page.redirect("/products")}catch(t){alert(t.message)}}),i)),(0,r.MN)(),(0,r.l$)()}i()}catch(p){i(p)}}))},18:(t,e,s)=>{s.a(t,(async(t,i)=>{try{s.d(e,{a:()=>u,o:()=>h});var a=s(885),r=s(555),n=s(718),o=s(160),c=s(368),l=t([n,o,c]);[n,o,c]=l.then?(await l)():l;const d=t=>a.dy`
    <!-- navbar -->
    ${(0,o.y)()}
    ...
    <!-- products -->
    ${(0,c.R)()}
  `;let h=(0,r.yX)("tempOrder");async function u(t){const e=h;t.render(d(e)),(0,r.MN)(),(0,r.l$)()}i()}catch(p){i(p)}}))},970:(t,e,s)=>{s.a(t,(async(t,i)=>{try{s.d(e,{d:()=>u});var a=s(885),r=s(40),n=s(555),o=s(160),c=s(718),l=s(18),d=t([o,c,l]);[o,c,l]=d.then?(await d)():d;const h=(t,e)=>a.dy`
  <!-- navbar -->
  ${(0,o.y)()}
...
`;i()}catch(t){i(t)}}))},160:(t,e,s)=>{s.a(t,(async(t,i)=>{try{s.d(e,{y:()=>c});var a=s(885),r=s(18),n=s(555),o=t([r]);r=(o.then?(await o)():o)[0];const c=()=>a.dy`
  <!-- navbar -->
  <nav class="navbar page">
    <div class="nav-center">
      ...
      <!-- cart icon -->
      <div class="toggle-container">
        <button @click=${n.l6} class="toggle-cart">
          <i class="fas fa-shopping-cart"></i>
        </button>
