...
`;async function p(t){const e=(await(0,l.gp)()).filter(((t,e)=>{if(1==e||5==e||9==e)return t}));t.render(u(n.o,r.lg,o.l6,e,(function(){t.page.redirect("/products"),(0,d.RT)()}))),document.querySelector(".page-loading").style.display="none",(0,r.MN)(),(0,r.l$)()}i()}catch(f){i(f)}}))},452:(t,e,s)=>{s.a(t,(async(t,i)=>{try{s.d(e,{K:()=>u});var a=s(885),r=s(40),n=s(555),o=s(160),c=s(718),l=s(18),d=t([o,c,l]);[o,c,l]=d.then?(await d)():d;const h=(t,e)=>a.dy`
...
`;async function u(t){const e=l.o;t.render(h(e,(async function(e){e.preventDefault();const s=new FormData(e.target),i=s.get("email").trim(),a=s.get("password").trim();if(!i||!a)return(0,n.h4)("Please fill in both fields!");try{await(0,r.x4)(i,a),t.page.redirect("/products")}catch(t){clg(t.message)}}))),document.querySelector(".page-loading").style.display="none",(0,n.MN)(),(0,n.l$)()}i()}catch(p){i(p)}}))},112:(t,e,s)=>{s.d(e,{M:()=>a});var i=s(885);function a(t){t.render(i.dy`<h2>404 Not Found</h2>`)}},880:(t,e,s)=>{s.a(t,(async(t,i)=>{try{s.d(e,{a:()=>u});var a=s(885),r=s(555),n=s(160),o=s(718),c=s(18),l=s(40),d=t([n,o,c]);[n,o,c]=d.then?(await d)():d;const h=(t,e,s)=>a.dy`
    <!-- navbar -->
