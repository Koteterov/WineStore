...
`;async function u(t){const e=l.o;t.render(h(e,(async function(e){e.preventDefault();const s=new FormData(e.target),i=s.get("email").trim(),a=s.get("password").trim(),o=s.get("re-password").trim();try{if(!i||!a)return(0,r.h4)("Please fill in all fields!");if(a!=o)return(0,r.h4)("Paswords don't match!");await(0,n.z2)(i,a),(0,r.MN)(),(0,r.l$)(),t.page.redirect("/products")}catch(t){console.log(object),t.message}}))),document.querySelector(".page-loading").style.display="none",(0,r.MN)(),(0,r.l$)()}i()}catch(p){i(p)}}))},718:(t,e,s)=>{s.a(t,(async(t,i)=>{try{s.d(e,{q:()=>o});var a=s(885),n=s(100),r=t([n]);n=(r.then?(await r)():r)[0];const o=t=>a.dy`
